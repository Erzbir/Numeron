...
import com.erzbir.mirai.numeron.plugins.rss.config.api.EditApi;
...
public class ReceiveCommand {
    @Command(name = "查看指定订阅启用的群和用户", dec = "#contacts [id]", help = "#contacts 1")
    @Message(
            text = "^#contacts\\s+?\\d+",
    ...
    @Command(name = "查看所有订阅启用的群和用户", dec = "#contacts [id]", help = "#contacts 1")
    @Message(
            text = "#contacts all",
            filterRule = FilterRule.BLACK,
            permission = PermissionType.MASTER
    ...
    @Command(name = "添加群订阅", dec = "#add group [id] [groupId]", help = "#add group 1 12344556")
    @Message(
    ...
    @Command(name = "取消群订阅", dec = "#delete group [id] [groupId]", help = "#delete group 1 12344556")
    @Message(
    ...
    @Command(name = "添加用户订阅", dec = "#add user [id] [qqId]", help = "#add user 1 12344556")
    @Message(
    ...
    @Command(name = "取消用户订阅", dec = "#delete user [id] [qqId]", help = "#delete user 1 12344556")
    @Message(
