...
import static com.erzbir.mirai.numeron.menu.IOUtils.getFont;
import static com.erzbir.mirai.numeron.menu.IOUtils.getGraphics2D;
...
public class MenuHelpDrawUtil {
    ...
    public static BufferedImage drawMenuHelp(String menuName) {
        ...
        graphics.setFont(getFont(Font.BOLD, 57));
        ...
        graphics.setFont(getFont(Font.ITALIC, 25));
    ...
    private static BufferedImage drawingContent(String menuName, int height) {
        ...
        Graphics2D graphics = getGraphics2D(drawingContentBuffer);
        ...
        graphics.setColor(Color.WHITE);
        graphics.setFont(getFont(Font.PLAIN, 30));
//        graphics.drawString(menuList.get(menuName), 20, 140);
    ...
    private static BufferedImage drawingTitle(String menuName, int width) {
        ...
        Graphics2D graphics = getGraphics2D(drawingTitleBuffer);
        graphics.setColor(new Color(76, 66, 76));
